...
<title>目标特性建模软件及几何模型管理平台——后台——网站日志</title>
...
<section id="modelView" class="content">
	<div class="widget-container">
	    <div id="PlatformLog"style="border:1px solid #ccc;padding:10px;">
	    	<h1>平台使用统计</h1>
	    	<div id="userActive" style="height:320px;border:1px solid #ccc;padding:10px;">
	    	</div>
	    	<div style="border:1px solid #ccc;">
		    	<div id="dataStatistics1" style="height:300px;width:35%;display:inline-block">
		    	</div>
		    	<div id="dataStatistics2" style="height:300px;width:35%;display:inline-block">
		    	</div>
		    </div>
	    </div>
	    <button class="green" onclick="loadPlatformDS()">load</button>
	</div>
</section>
...
<script src="../js/bootstrap/platformLog.js"></script>
