...
<title>目标特性建模软件及几何模型管理平台——后台——用户日志</title>
...
<section id="modelView" class="content">
	<div class="widget-container">
	    <div id="userLog"style="border:1px solid #ccc;padding:10px;">
	    	<h1>用户使用统计</h1>
	    	<div id="timeInterval" style="height:300px;border:1px solid #ccc;padding:10px;"></div>
	    	<div id="recentSoft" style="height:50px;border:1px solid #ccc;padding:10px;">
		    	<h1>最近常用软件</h1>
		    	<div style="margin:10px">
					<a style="color:red;font-size:16px;border:1px solid rgba(145, 239, 246, 1);padding:2px;" herf="#">
					FEKO</a>
					<a style="color:red;font-size:16px;border:1px solid rgba(145, 239, 246, 1);padding:2px;" herf="#" onclick="">
					COMSOL</a>
					<a style="color:red;font-size:16px;border:1px solid rgba(145, 239, 246, 1);padding:2px;" herf="#">
					CST</a>
					<a herf="#" style="color:blue;">更多..</a>
				</div>
	    	</div>
	    	<div style="height:auto;min-height:200px;border:1px solid #ccc;padding:10px;">
	    		<div id="dataStatistics" style="height:200px;border:1px solid #ccc;padding:10px;width:50%;display:inline-block;float:left">
	    		</div>
	    		<div style="height:80px;width:45%;display:inline-block;border:1px solid #ccc;">
	    			<h1>最近常用模型</h1>
	    			<div style="margin:10px">
						<a style="color:red;font-size:16px;border:1px solid rgba(145, 239, 246, 1);padding:2px;" herf="#">
						ball.stl</a>
	    ...
	    <button class="green" onclick="loadUserLog()">load</button>
	</div>
</section>
...
<script src="../js/bootstrap/userlogEchart.js"></script>
<script type="text/javascript">
loadUserLog('<%=request.getParameter("logowner")%>');
