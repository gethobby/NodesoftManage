...
if(session.getAttribute("username")==null) 
    	response.sendRedirect("/NodesoftManage/login.jsp?frompage=ComputeMain.jsp");
...
<title>目标特性建模软件及几何模型管理平台——模型计算</title>
...
<nav>
	<ul id="navBar">
		...
		<li class="section"><a href="ComputeMain.jsp" class="computes" title="Computes"><span class="icon">&#59214;</span> 模型计算</a></li>
