...
function loadSoftInfo(softid)
{
	if(softid){
		$("#SoftID").val(softid);
		$.ajax({
	    	url: '/NodesoftManage/GetDetailInfo?infotype=soft&id='+softid+"&tid="+Math.random(),
...
function modifyBasicinfo()
{
	...
	$.ajax({   
	     type: "POST",   
	     url: "/NodesoftManage/UpdateSoftinfo?scope=basicinfo&id="+softID+"&tid="+Math.random(),   
	     data:jsonObject,
...
function modifySoftFuncDesc()
{
	...
	$.ajax({   
	     type: "POST",   
	     url: "/NodesoftManage/UpdateSoftinfo?scope=softfunctiondesc&id="+softID+"&tid="+Math.random(),   
	     data:jsonObject,
	     success:function(str_response){
	    	 if("success"==str_response)
	    	 {
...
function modifySoftComputeExample()
{
	...
	$.ajax({   
	     type: "POST",   
	     url: "/NodesoftManage/UpdateSoftinfo?scope=softcomputeexample&id="+softID+"&tid="+Math.random(),   
	     data:jsonObject,
	     success:function(str_response){
	    	 if("success"==str_response)
	    	 {
...
function modifySoftResultExample()
{
	...
	$.ajax({   
	     type: "POST",   
	     url: "/NodesoftManage/UpdateSoftinfo?scope=softresultexample&id="+softID+"&tid="+Math.random(),   
	     data:jsonObject,
	     success:function(str_response){
	    	 if("success"==str_response)
	    	 {
...
function modifyContactinfo()
{
	...
	$.ajax({   
	     type: "POST",   
	     url: "/NodesoftManage/UpdateSoftinfo?scope=contactinfo&id="+softID+"&tid="+Math.random(),   
	     data:jsonObject,
	     success:function(str_response){
	    	 if("success"==str_response)
	    	 {
