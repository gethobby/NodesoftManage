...
function applyNode(username,toolname,objmodelID)
{
	...
	{ 
		...
		var applyurl="/NodesoftManage/ApplynodeServlet";
		if(objmodelID){
		...
		function opennode(ip,user,psw,port,tool,loginuser,model){
			...
			var newnodeurl="/NodesoftManage/Webfront/Tool.html";
			$.ajax({   
			     type: "POST",   
			     url: newnodeurl,   
...
//			        	
//			        	var relseaeServletUrl="/NodesoftManage/ReleasenodeServlet?nodeip="+ip+"&account="+user+
