...
public interface Gobal {
	...
	//存放与节点机交流的C++软件的路径
	String NODE_COMMUNICATE_APP="D:\\SeuDeploy\\NodesoftManage_Deploy\\ServersideControl.exe";
	String RESULT_RECEIVE_APP="D:\\SeuDeploy\\NodesoftManage_Deploy\\ResultServerSide.exe";
	...
	//所有模型文件存放路径
	String OBJECT_ROOT_DIR="D:\\SeuDeploy\\ObjectModelfile";
	//所有图片存放路径
	String PICTURE_ROOT_DIR="D:\\SeuDeploy\\Pictures";
