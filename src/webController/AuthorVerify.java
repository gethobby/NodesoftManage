...
//	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ch.isSuccess())
		{
			...
			if(request.getParameter("backsystem")==null){
				if(frompage==null||frompage=="")
					response.sendRedirect("/NodesoftManage/Webfront/ComputeMain.jsp");
				else response.sendRedirect("/NodesoftManage/Webfront/"+frompage);
				logger.debug(username+" Login in success!");
			}
			else{
				if(frompage==null||frompage=="")
					response.sendRedirect("/NodesoftManage/Webback/UserManage.jsp");
				else response.sendRedirect("/NodesoftManage/Webback/"+frompage);
		...
		else
		{
			...
			//response.sendRedirect("/NodesoftManage/login.jsp?loginerror=true");
		}
